...
int main()
{  printf("Banking system created by Saurabh Sanjeev(Reg no- RA211100400413)\n\n\n\n ");
    printf("                             Note:-Password is 'saurabh' ");
    char pass[10],password[10]="saurabh";
    int i=0;
